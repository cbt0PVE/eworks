...
namespace open_address
{
    ...
    template<class K,class V,class DefaultHashFunc<K>>
    class HashTable
    {
        public:
        HashTable()
...
namespace hash_bucket
{
    ...
    struct HashTableIterator
    {
        ...
        typedef HashTable<K,T,T*,T&,KeyOfT,HashFunc> Iterator;
        ...
        //普通迭代器时，是拷贝构造
        //const迭代器时，是构造
        HashTableIterator(const Self& it)
        :node_(it.node_)
        ,pht_(it.pht_)
        {}
        Ref operator*()
    ...
    template<class K,class T,class KetOfT,class HashFunc>
    class HashTable
    {
        typedef HashNode<T> Node;
        template<class K,class T,class Ptr,class Ref,class KeyOfT,class HashFunc>
